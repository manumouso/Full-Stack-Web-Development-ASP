...
namespace Educacion.Models
{
    ...
    public partial class EducacionDBEntities : DbContext
    {
        public EducacionDBEntities()
            : base("name=EducacionDBEntities")
        {
        }
        ...
        public virtual DbSet<AlumnosCurso> AlumnosCursos { get; set; }
